package br.com.lucasnoronha.medicalconsult.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("LUCAS").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("NORONHA").password(passwordEncoder.encode("98765")).roles("PACIENTE")
                .and()
                .withUser("MENEZES").password(passwordEncoder.encode("121212")).roles("SECRETARIO");
